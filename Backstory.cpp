...
bool Backstory::Init()
{
	...
	title = D3D::LoadTexture("sprites/titles/backstory.png");
	text = D3D::LoadTexture("sprites/backstory.png");
...
bool Backstory::Render(float deltaTime)
{
...
void Backstory::Update(float deltaTime)
{
...
void Backstory::Exit(GameState *nextState)
{
